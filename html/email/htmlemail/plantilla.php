...
$consultaParaEnviarEmail = mysqli_query($con, "select i.servicio as dat1, i.fecha_afiliacion as dat2, i.costo_plan as dat3, t.nombre_tipo as dat4, c.idcliente as dat5, p.nombre as dat6, DATE_ADD(i.fecha_afiliacion, INTERVAL FLOOR(DATEDIFF(CURDATE(), i.fecha_afiliacion) / 30) MONTH) AS dat7
                  ...
                  <tr>
                    <td align="left" class="mobile-padding" style="padding:20px">
                      ...
                      <div>
                        ...
                        <br>
                        Le recordamos que debe de realizar pagos por los servicios de Consultancy antes de la fecha: '.$fechaVencimiento.'.
