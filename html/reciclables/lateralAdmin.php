...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo" style="background-color: #D0D3D4;">
    <a href="AdminHome.php" class="app-brand-link gap-2">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="cuentaAdmin.php" class="menu-link">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Misc">Carga de Información</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="AdminHome.php" class="menu-link">
            <div data-i18n="Error">Adm. Clientes</div>
          </a>
        </li>        
      </ul>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="AdminDocumentos.php" class="menu-link">
            <div data-i18n="Error">Adm. Documentos</div>
          </a>
        </li>        
      </ul>
    </li>    
