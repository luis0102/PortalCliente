            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Información Tributaria /</span> Persona Moral</h4>
                        <?php
                        ...
                        <div class="card">
                            <h5 class="card-header">Declaraciones de Persona Moral - SAT</h5>
                            <div class="table-responsive text-nowrap">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $ConsultaEmpresas = mysqli_query($con, "select d.mes as dat1,  FORMAT(ROUND(d.isr, 2), '0.00') as dat2, d.iva as dat3, d.isr+d.iva as dat4,d.idestado_doc as dat5, d.ruta as dat6
                                            FROM doc_tributacion d, tipo t, tipo_documento td 
                                            WHERE d.idinfo=$idinfo AND d.idtipo=t.idtipo AND d.idtipo_documento=td.idtipo_documento AND d.idtipo=2 AND d.idtipo_documento=1");
                                        $ContTabEmpresas1 = 1;
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $ConsultaEmpresas = mysqli_query($con, "select d.mes as dat1, d.isr as dat2, d.iva as dat3, d.isr+d.iva as dat4, d.idestado_doc as dat5, d.ruta as dat6 
                                            FROM doc_tributacion d, tipo t, tipo_documento td 
                                            WHERE d.idinfo=$idinfo AND d.idtipo=t.idtipo AND d.idtipo_documento=td.idtipo_documento AND d.idtipo=2 AND d.idtipo_documento=2");
                                        $ContTabEmpresas2 = 1;
                                        while ($valorft = mysqli_fetch_array($ConsultaEmpresas)) {
                                            $servicioss = $valorft['dat1'];
                                            echo "<tr>
